...
namespace Ejercicio_Sobrecarga
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Creo 4 productos
            Producto.Producto p1 = new Producto.Producto("Pepsi", "PESDS97413", (float)18.5);
            Producto.Producto p2 = new Producto.Producto("Coca-Cola", "COSDS55752", (float)11.5);
            Producto.Producto p3 = new Producto.Producto("Manaos", "MASDS51292", (float)20.5);
            Producto.Producto p4 = new Producto.Producto("Crush", "CRSDS54861", (float)10.75);
            Producto.Producto p5 = null;
